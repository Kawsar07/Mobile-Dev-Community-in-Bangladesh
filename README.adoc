...
|Kawsar Ali
|Software Engineer at Scube Technologies Ltd.
|Flutter , Kotlin , API , Firebase , MVC , MVVM, SQLITE, Hive, Git , C , Dart , Swift , C# , PostgreSQL , SQL , ASP.NET Core 6, Docker, Heroku, Postman, Jira, Trello.
|Email: kawsar.ali.cse@gmail.com
https://github.com/Kawsar07[Github] 
https://bd.linkedin.com/in/kawsar-ali-93396313a[Linkedin]
Phone : +88017xxxxxxx
